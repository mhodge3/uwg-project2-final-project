...
CREATE TABLE IF NOT EXISTS `rpg_story_mapper_db`.`charactersPlayer` (
  ...
  UNIQUE INDEX `character_player_id_UNIQUE` (`character_player_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `rpg_story_mapper_db`.`quests` (
  ...
  UNIQUE INDEX `pre_req_quest-id_UNIQUE` (`pre_req_quest-id` ASC) VISIBLE,
  UNIQUE INDEX `confict_id_UNIQUE` (`confict_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `rpg_story_mapper_db`.`characterPlayerQuestLog`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rpg_story_mapper_db`.`characterPlayerQuestLog` (
...
CREATE TABLE IF NOT EXISTS `rpg_story_mapper_db`.`conflicts` (
  ...
  UNIQUE INDEX `confkict_id_UNIQUE` (`confkict_id` ASC) VISIBLE,
  UNIQUE INDEX `conflict_name_UNIQUE` (`conflict_name` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `rpg_story_mapper_db`.`gameStory` (
  ...
  UNIQUE INDEX `game_story_name_UNIQUE` (`game_story_name` ASC) VISIBLE)
ENGINE = InnoDB;
